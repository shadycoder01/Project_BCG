...
class main:
    def __init__(self):
        self.input_path = configuration.Configuration(os.getcwd(),'input_data','output_data').get_units_use_path()
        self.output_path = configuration.Configuration(os.getcwd(),'input_data','output_data').output_path_analysis_4()
